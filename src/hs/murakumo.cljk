...
(defn collection
  [name]
  (str "com.etzhayyim.hs." name))

(def cell-specs {
  :getnode {:legacy-cell "com-etzhayyim-apps-hs-getNode"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getnode")]
     :required-gates common-gates
     :trigger "manifest cell getnode"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getchildren {:legacy-cell "com-etzhayyim-apps-hs-getChildren"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getchildren")]
     :required-gates common-gates
     :trigger "manifest cell getchildren"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :resolveconcordance {:legacy-cell "com-etzhayyim-apps-hs-resolveConcordance"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "resolveconcordance")]
     :required-gates common-gates
     :trigger "manifest cell resolveconcordance"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :getpolicyoverlay {:legacy-cell "com-etzhayyim-apps-hs-getPolicyOverlay"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "getpolicyoverlay")]
     :required-gates common-gates
     :trigger "manifest cell getpolicyoverlay"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :health {:legacy-cell "com-etzhayyim-apps-hs-health"
     :phase :event
     :murakumo-node "reuben"
  ...
  :domain-knowledge {:legacy-cell "domain-knowledge"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :node {:legacy-cell "com-etzhayyim-apps-hs-node"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "node")]
     :required-gates common-gates
     :trigger "manifest cell node"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :concordance {:legacy-cell "com-etzhayyim-apps-hs-concordance"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "concordance")]
     :required-gates common-gates
     :trigger "manifest cell concordance"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :tradeevidence {:legacy-cell "com-etzhayyim-apps-hs-tradeEvidence"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "tradeevidence")]
     :required-gates common-gates
     :trigger "manifest cell tradeevidence"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :policyoverlay {:legacy-cell "com-etzhayyim-apps-hs-policyOverlay"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "policyoverlay")]
     :required-gates common-gates
     :trigger "manifest cell policyoverlay"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
